...
class DataSpliter:
    ...
    def split_data(self):
        ...
        self.group_wind = self.df[["date", "wind_gusts_10m_mean", "wind_speed_10m_mean", "winddirection_10m_dominant"]]
        self.group_solar = self.df[["date", "daylight_duration", "sunshine_duration", "cloud_cover_mean"]]
...
class DataMerger():
    ...
    # Store Dataframes from api or csv sources 
        ...
        self.name = name
    def merge_data(self, on_column, how="inner"):
        """
